            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">上报登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="shangbaoName" name="shangbaoName" class="form-control"
                                               v-model="ruleForm.shangbaoName" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>上报内容</label>
                                        <input style="width: 450px" id="shangbaoText" name="shangbaoText" class="form-control"
                                               v-model="ruleForm.shangbaoText" readonly>
                                    </div>
