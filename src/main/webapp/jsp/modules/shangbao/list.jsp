...
<!--/Pre Loader -->
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">上报管理</li>
                            <li class="breadcrumb-item active">上报列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="shangbaoNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="上报标题" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //上报标题
            var shangbaoNameSearchInput = $('#shangbaoNameSearch');
            if( shangbaoNameSearchInput != null){
                if (shangbaoNameSearchInput.val() != null && shangbaoNameSearchInput.val() != '') {
                    searchForm.shangbaoName = $('#shangbaoNameSearch').val();
                }
            }
                                getDataList();
        }
        ...
        function getDataList() {
            http("shangbao/page", "GET", {
                ...
                shangbaoDelete: 1,
                //本表的
                shangbaoName: searchForm.shangbaoName,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(newMoneyCell);
                        ...
                        //是否会员
            var shifouhuiyuanTypesCell = document.createElement('td');
            shifouhuiyuanTypesCell.innerHTML = item.shifouhuiyuanValue;
            row.appendChild(shifouhuiyuanTypesCell);


                    //会员截止日期
            var huiyuanTimeCell = document.createElement('td');
            huiyuanTimeCell.innerHTML = item.huiyuanTime;
            row.appendChild(huiyuanTimeCell);


            //上报标题
            var shangbaoNameCell = document.createElement('td');
            shangbaoNameCell.innerHTML = item.shangbaoName;
            row.appendChild(shangbaoNameCell);


            //上报内容
            var shangbaoTextCell = document.createElement('td');
            shangbaoTextCell.innerHTML = item.shangbaoText;
            row.appendChild(shangbaoTextCell);
