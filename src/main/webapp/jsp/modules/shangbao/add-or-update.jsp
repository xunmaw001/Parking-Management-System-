            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑上报</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6 shangbaoNameDiv">
                                        <label>上报标题</label>
                                        <input style="width: 450px" id="shangbaoName" name="shangbaoName" class="form-control"
                                               placeholder="上报标题">
                                    </div>
                                    <div class="form-group col-md-6 shangbaoTextDiv">
                                        <label>上报内容</label>
                                        <textarea style="width: 450px"  id="shangbaoText" name="shangbaoText" class="form-control"placeholder="上报内容"></textarea>
                                    </div>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                yonghuId: "required",
                shangbaoName: "required",
                shangbaoText: "required",
                replyText: "required",
            },
            messages: {
                yonghuId: "用户不能为空",
                shangbaoName: "上报标题不能为空",
                shangbaoText: "上报内容不能为空",
                replyText: "回复内容不能为空",
            }
        }).form();
    }
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#shangbaoName").val(ruleForm.shangbaoName);
        $("#shangbaoText").val(ruleForm.shangbaoText);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            $('#shangbaoText').attr('readonly', 'readonly');
