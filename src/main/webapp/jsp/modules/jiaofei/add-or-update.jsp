                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6 jiaofeiMoneyDiv">
                                        <label>缴费金额</label>
                                        <input style="width: 450px" id="jiaofeiMoney" name="jiaofeiMoney" class="form-control"
                                               onchange="jiaofeiMoneyChickValue(this)" placeholder="缴费金额">
                                    </div>
                                    <div class="form-group  col-md-6 jiaofeiContentDiv">
                                        <label>备注</label>
    ...
    function getContent() {
        ...
        if($("#jiaofeiContentupload").length>0) {
            ...
            if (jiaofeiContentEditor.hasContents()) {
                $('#jiaofeiContent-input').attr('value', jiaofeiContentEditor.getContent());
            }
        }
    }
    //数字检查
