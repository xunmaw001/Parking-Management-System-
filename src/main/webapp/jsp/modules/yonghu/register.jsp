...
<body style="background-image:url('/tingcheguanli/img/back-img-bg.jpg') !important;background-size:cover;">
<!-- Pre Loader -->
<div class="loading">
    <div class="spinner">
                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                   ...
                                   <div class="form-group col-md-12">
                                       <label>是否会员</label>
                                       <select id="shifouhuiyuanTypesSelect" name="shifouhuiyuanTypes" class="form-control">
                                       </select>
                                   </div>
                                   <div class="form-group col-md-12">
                                       <label>会员截止日期</label>
                                       <input id="huiyuanTime-input" name="huiyuanTime" size="20"  type="month" class="form-control">
                                   </div>
                                <div class="form-group col-md-12">
