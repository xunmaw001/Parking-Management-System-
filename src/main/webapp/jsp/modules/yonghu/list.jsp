...
<!--/Pre Loader -->
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //重置密码
            var xufeiBtn = document.createElement('button');
            var xufeiAttr = "xufei(" + item.id + ')';
            xufeiBtn.setAttribute("type", "button");
            xufeiBtn.setAttribute("class", "btn btn-info btn-sm 修改");
            xufeiBtn.setAttribute("onclick", xufeiAttr);
            xufeiBtn.innerHTML = "续费1个月";
            btnGroup.appendChild(xufeiBtn);
