...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">停车记录管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">停车记录列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">停车记录列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //进场时间
            var jinTimeCell = document.createElement('td');
            jinTimeCell.innerHTML = item.jinTime;
            row.appendChild(jinTimeCell);


            //出场时间
            var chuTimeCell = document.createElement('td');
            chuTimeCell.innerHTML = item.chuTime;
            row.appendChild(chuTimeCell);


            //天
            var tianCell = document.createElement('td');
            tianCell.innerHTML = item.tian;
            row.appendChild(tianCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("tingchejilu/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addtingchejilu", "addtingchejilu");
            window.location.href = "add-or-update.jsp"
        }
