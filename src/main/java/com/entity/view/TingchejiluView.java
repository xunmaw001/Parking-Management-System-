...
public class TingchejiluView extends TingchejiluEntity implements Serializable {
	...
	public TingchejiluView() {

	}

	public TingchejiluView(TingchejiluEntity tingchejiluEntity) {
		try {
			BeanUtils.copyProperties(this, tingchejiluEntity);
